...
クラス名は、なるべく**文脈から独立**した、部品としての特徴を捉えた名称にすべきです。
...
![Tags example](../assets/example_tags.png)
...
![List example 1](../assets/example_list_1.png)

![List example 2](../assets/example_list_2.png)

ただし、コンポーネントには**汎用的であるべき**ものと**特殊でも構わない**ものの2種類があります。
